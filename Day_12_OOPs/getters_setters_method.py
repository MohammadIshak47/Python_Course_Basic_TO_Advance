...
To use the getter, we can create an instance of the MyClass class, and then access the 
value property as if it were an attribute:
...
properties, while keeping the internal representation of the property hidden. This can 
