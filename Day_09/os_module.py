...
Finally, the os module provides functions for running system commands. For example, you 
...
such as reading and writing files, interacting with the file system, and running system 
commands.
'''
