...
total_true_love_score = true_score+love_score

if total_true_love_score<10 or total_true_love_score>90:
    print(f"Your total score is {total_true_love_score},you go together like coke and mentos.")
elif 40<=total_true_love_score<=50:
    print(f"Your total score is {total_true_love_score},you are alright together.")  
else:
